    ...
    <div class="ui one column grid center aligned" style="margin-top: 30px">
        <div class="column">
            <div class="ui raised segment left aligned">
                <div class="column"><h3 class="ui dividing header">Fragebogen <?php echo $title; ?> beantworten</h3>
                </div>
                <div class="ui grid">
                    <div class="ui sixteen wide column"></div>
                    <div class="row"><h5 class="ui header"> Es können Werte von 1 (gut) bis 5 (schlecht) vergeben
                            werden!</h5>
                    </div>
                </div>
                <form action="index.php?view=use" method="post">
                    <table class="ui striped collapsing celled table">
                        ...
                        if ($query = getDbConnection()->prepare($sql)) {
                            ...
                            foreach ($result as $row):
                                ...
                                <td>
                                    <div class=\"ui input\">
                                    <input type=\"number\" name=\"range".$id."\" min=\"1\" max=\"5\" step=\"1\">
                                     </div>
                                </td>
                            ...
                            <div class="ui labeled input">
                                ...
                                <div class="ui input">
                                    <input type="text" name="comment"
                                           value=<?php if ($valueComment) echo $valueComment ?>>
                                </div>
                            </div>
                        </div>
                        <button class="ui teal button submit" name="saveComment" type="submit">Kommentar speichern
                        </button>

                        <div class="row">
                            <div class="column">
                                <button class="ui teal right floated button" type="submit" name="saveSurvey">Fragebogen
                                    absenden
                                </button>
                            </div>
                        </div>

...
<div class="ui grid">
       ...
       <div class="ui sixteen wide column">
           <?php
                ...
                <form method="post" action="index.php?view=edit_survey"> <button class="ui inverted secondary icon button" name="edit" type="submit" value='.$data[$i].' > <i class="edit icon"></i></button></form>
               <form method="post" action ="index.php?view=copy_survey">  <button class="ui inverted secondary icon button" name="copy" type="submit" value='.$data[$i].'><i class="copy icon"></i></button></form>
